...
trait DesStub {
  ...
  def createAgentKnownFactsValid(agentRef: AgentReference): Unit =
    stubFor(
      post(urlEqualTo(config.desEndpoint(agentRef.value)))
  ...
  def createAgentKnownFactsInvalidAgentId(agentRef: AgentReference) =
    stubFor(
      post(urlPathEqualTo(config.desEndpoint(agentRef.value)))
  ...
  def createAgentKnownFactsInvalidRegime(agentRef: AgentReference) =
    stubFor(
      post(urlPathEqualTo(config.desEndpoint(agentRef.value, "AAA")))
        .withHeader("Content-Type", containing("application/json"))
        .withRequestBody(
          equalToJson(
            s"""{
  ...
  def createAgentKnownFactsInvalidBoth =
    stubFor(
      post(urlPathEqualTo(config.desEndpoint("ZZ0000", "AAA")))
        .withHeader("Content-Type", containing("application/json"))
        .withRequestBody(
          equalToJson(
            s"""{
